...
export function heroIconUrl(hero: Pick<Hero, 'typeId'> | null | undefined, options?: AssetUrlOptions): string | undefined;
...
export interface StandardGameAssetResolver {
  ...
  hero(match: Pick<Match, 'isReforged'>, hero: Pick<Hero, 'typeId'> | null | undefined): string | undefined;
