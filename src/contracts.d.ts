...
export type OverlayState<TOverlayExtensions extends object = object> = TOverlayExtensions extends OverlayExtensionsInput<TOverlayExtensions> ? DeepReadonly<TOverlayExtensions> : never;
