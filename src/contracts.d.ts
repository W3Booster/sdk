...
export type OverlayState<TOverlayExtensions extends object = object> = TOverlayExtensions extends JsonCompatible<TOverlayExtensions> ? Extract<keyof TOverlayExtensions, OverlayExtensionReservedKey> extends never ? DeepReadonly<TOverlayExtensions> & {
...
export interface MatchLifecycleObservationEvent<TSettings extends object = JsonObject, TOverlayExtensions extends object = object> extends MatchLifecycleEvent<TSettings, TOverlayExtensions> {
    readonly phase: 'started' | 'ended'; /** True when subscription observes a match that was already active. */
    readonly initial: boolean;
}
...
export type ClientOptionsInput<TSettings extends object, TOverlayExtensions extends object> = TSettings extends JsonCompatible<TSettings> ? TOverlayExtensions extends JsonCompatible<TOverlayExtensions> ? ConnectOptions<TSettings, TOverlayExtensions> | string : never : never;
